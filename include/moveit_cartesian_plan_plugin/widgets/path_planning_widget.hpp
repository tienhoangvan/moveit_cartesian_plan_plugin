 ...
 */
		...
		protected Q_SLOTS:
			...
			void getJoints();        								// TIEN VIET THEM
			
			//void jointUpdate(std::vector<double>);        								// TIEN VIET THEM
			void jointUpdate(double q1, double q2, double q3, double q4, double q5, double q6);
			//! Add joint goal at Home
			
			void jointHome();        											// TIEN VIET THEM
			//! Add joint goal at Home

			void jointAddUI();        											// TIEN VIET THEM
			//! Add joint goal
			...
			//! Slot for disabling the TabWidged while Joint Space is executed.			// TIEN VIET THEM
			void JointSpaceStartedHandler();										
			
			//! Slot for enabling the TabWidged after Cartesian Path is executed.
			void cartesianPathFinishedHandler();

			//! Slot for enabling the TabWidged after Joint Space is executed.			// TIEN VIET THEM
			void JointSpaceFinishedHandler();									
		...
		Q_SIGNALS:
		    ...
		    void getJoints_signal();									// TIEN VIET THEM
		    
		    void addJoint(std::vector<double> joints);									// TIEN VIET THEM
		    //! Notify RViz enviroment that a new Joints has been added from RQT.
